package bahram.springframework.springrecipewebapp.bootstrap;

import bahram.springframework.springrecipewebapp.domain.*;
import bahram.springframework.springrecipewebapp.repositories.CategoryRepository;
import bahram.springframework.springrecipewebapp.repositories.RecipeRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.setDirections("1 Cut avocado, remove flesh: Cut the avocados in half. Remove seed. Score the inside of the avocado with a blunt knife and scoop out the flesh with a spoon" +
                ...
                "\n" +
                "3 Add salst, lime juice, and the rest: Sprinkle with salt and lime (or lemon) juice. The acid in the lime juice will provide some balance to the richness of the avocado and will help delay the avocados from turning brown.\n" +
